...
const todoInput: By = By.xpath("//*[@class='new-todo']");
// this locator will find ALL the todos
const todos: By = By.xpath("//*[@class='todo']");
// this locator will find the text of a todo FROM the todo
const todoLabel: By = By.xpath("//*[@class='new-todo']");
...
const clearCompletedButton: By = By.xpath("//button[@class='clear-completed']");
